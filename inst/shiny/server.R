...
shinyServer(function(input, output){
  ...
  output$summary = renderUI({
    if (posterior40() | posterior20()){
      ...
      summary_text <- paste("Posterior distributions update the priors implied by the opinions: Q1 = ", input$pc_q1, ", Q2 = ", input$pc_q2, ", Q3 = ", input$theta_q1, ", Q4 = ", input$theta_q2, "\n",
      ...
      summary_text <- paste(
        glue::glue("Prior distributions are determined by the opinions: Q1 = {input$pc_q1} Q2 = {input$pc_q2} Q3 = {input$theta_q1} Q4 = {input$theta_q2}"),
        "Summary of the prior distribution of the 6-month remission rate on CYC/steroids:",
